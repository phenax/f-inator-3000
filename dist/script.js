...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FInator = __webpack_require__(5);
	
	var _FInator2 = _interopRequireDefault(_FInator);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	(0, _reactDom.render)(_react2.default.createElement(_FInator2.default, null), document.getElementById('appRoot'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FInatorInput = __webpack_require__(6);
	
	var _FInatorInput2 = _interopRequireDefault(_FInatorInput);
	
	var _FInatorOutput = __webpack_require__(8);
	
	var _FInatorOutput2 = _interopRequireDefault(_FInatorOutput);
	
	var _fuckinate = __webpack_require__(10);
	
	var _fuckinate2 = _interopRequireDefault(_fuckinate);
	
	var _finator = __webpack_require__(12);
	  ...
	  */
		...
		_createClass(FInator3000, [{
			...
			value: function _finateText(string) {
				...
				return _fuckinate2.default.transform(string);
			}
	   ...
	   */
			...
			value: function onSubmit(text) {
				...
				this.setState({ response: response, request: text });
			}
	   ...
	   */
			...
			key: 'fbShareButtonClick',
			value: function fbShareButtonClick() {
	
				var quoteMessage = this.state.request ? 'Fuckinator fuckinated my fucking text from "' + this.state.request + '" to: "' + this.state.response + '"' : null;
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					this.state.request ? _react2.default.createElement(
						'div',
						{ style: { textAlign: 'right' } },
						_react2.default.createElement(
							'button',
							{ style: _finator2.default.shareBtn, onClick: this.fbShareButtonClick.bind(this) },
							'Share on facebook'
						)
					) : null
				);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _finator__input = __webpack_require__(7);
	...
	var FInatorInput = function (_React$Component) {
		...
		function FInatorInput() {
			_classCallCheck(this, FInatorInput);
	
			return _possibleConstructorReturn(this, (FInatorInput.__proto__ || Object.getPrototypeOf(FInatorInput)).apply(this, arguments));
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _finator__output = __webpack_require__(9);
	...
	var FInatorOutput = function (_React$Component) {
		_inherits(FInatorOutput, _React$Component);
	
		function FInatorOutput() {
			_classCallCheck(this, FInatorOutput);
	
			return _possibleConstructorReturn(this, (FInatorOutput.__proto__ || Object.getPrototypeOf(FInatorOutput)).apply(this, arguments));
		}
	
		_createClass(FInatorOutput, [{
			key: 'render',
			value: function render() {
				return _react2.default.createElement(
					'div',
		...
		return FInatorOutput;
	}(_react2.default.Component);
	
	exports.default = FInatorOutput;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var nlp = __webpack_require__(11);
	
	module.exports = {
	
		transform: function transform(string) {
	
			// Convert string into nlp object
			var response = nlp.text(string);
